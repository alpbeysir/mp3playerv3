...
namespace MP3Player.Youtube
{
    ...
    /// <summary>
    /// ICodeReciever implementation changed slightly to be compatible with Unity on Android.
    /// </summary>
    public class CompatibleCodeReciever : ICodeReceiver
    {
        /// <summary>
        ...
        /// <summary>
        /// Create an instance of <see cref="CompatibleCodeReciever"/>.
        /// </summary>
        public CompatibleCodeReciever() : this(DefaultClosePageResponse, CallbackUriChooserStrategy.Default) { }

        /// <summary>
        /// Create an instance of <see cref="CompatibleCodeReciever"/>.
        /// </summary>
        /// <param name="closePageResponse">Custom close page response for this instance</param>
        public CompatibleCodeReciever(string closePageResponse) :
        ...
        public CompatibleCodeReciever(string closePageResponse, CallbackUriChooserStrategy strategy)
        {
